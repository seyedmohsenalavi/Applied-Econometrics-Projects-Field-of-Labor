	...
	/*
			...
			Steps for Regression:				
				...
				step  2  |  Generate Logit regressions & Margins; then, export them to tex 
				step  3  |  Generate OLS, Probit regressions for comparing them with Logit 
							and generate Logit for males, Urbans & Logit with clustring for families
	--------------------------------------------------------------------------*/
